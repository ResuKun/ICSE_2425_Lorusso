...
class UpdateMeldMove(PlayerMove):
    def __init__(self, player: BurracoPlayer, action: UpdateMeldAction, meld_id, card: Card, accumulatedScore: int):
        super().__init__(player, action)
    ...
    def __str__(self):
        return "{} {} {} {} {}".format(self.player, self.action, self.meld_id, self.card, self.accumulatedScore)
