...
class Boosting_learner(Learner):
    def __init__(self, dataset, base_learner_class, subsample=0.8):
        ...
        self.errors = [data.evaluate_dataset(data.valid, self.predictor, Evaluate.squared_loss)]
    ...
    def learn(self, num_ensembles=10):
        ...
        for i in range(num_ensembles):
            ...
            self.errors.append(data.evaluate_dataset(data.valid, self.predictor, Evaluate.squared_loss))
    ...
    def learn(self):
        for i in range(self.number_trees):
            ...
            self.display(1,f"""Iteration {i} treesize = {tree.num_leaves} train logloss={
                ...
                self.dataset.evaluate_dataset(self.dataset.valid, self.gtb_predictor, Evaluate.log_loss)}""")
